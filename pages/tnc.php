...
<head>
    ...
    .v-tnc-tabpad {
        border-radius: 20px;
        -webkit-box-shadow: 0 3px 14px 0px rgba(0, 0, 0, 0.19);
        box-shadow: 0 3px 14px 0px rgba(0, 0, 0, 0.19);
        padding: 15px;
        margin: 12px auto;
        max-width: 667px;
    }
...
<body>
    ...
    <section class="main_container" style=" ">
        ...
        <div class="v-tnc-tabpad">
            <h1><?php echo site::name;?> Terms & Conditions</h1>
        </div>
        <div class="v-tnc-tabpad">
            <h2>Terms of use</h2>By accessing the website at <b><?php echo site::url("server");?></b>, you are agreeing to be
        ...
        <br><br>
        <div class="v-tnc-tabpad" id="ppl">
            <h1><?php echo site::name;?> Privacy Policy</h1>
        </div>
        <div class="v-tnc-tabpad">
            <section>
                <h2>Privacy Policy - Effective Date: [Date]</h2>
                <p><strong><?php echo site::name;?></strong> ("we", "our", "us") is committed to protecting your
                    ...
                    when you visit our website <a
                        href="<?php echo site::url("domain");?>"><?php echo site::url("server");?></a> (the "Site") and
                    when you use our services.</p>

                <p>Please read this Privacy Policy carefully. By accessing or using our Site or services, you agree to
                    this Privacy Policy. If you do not agree with this Privacy Policy, do not access or use our Site or
                    services.</p>
            </section>
            ...
            <section>
                ...
                <p>We may also collect non-personal information about you automatically when you access or use our Site.
                    This may include:</p>
                <ul>
                    <li>Browser type</li>
            ...
            <section>
                ...
                <ul>
                    ...
                    <li>To communicate with you, either directly or through one of our partners, including for customer
                        service, to provide you with updates and other information relating to the Site, and for
            ...
            <section>
                ...
                <p>We use reasonable administrative, technical, and physical security measures to protect your personal
            ...
            <section>
                ...
                <p>We may update this Privacy Policy from time to time in order to reflect changes to our practices or

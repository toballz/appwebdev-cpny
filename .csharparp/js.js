!(function (addParam2Url, preventContextMenu, changePage, modalFuncReturnId, toastFuncReturnId, websiteUri) {
    var  apiC = "./apim.php", overridedListFromPosted = [], overridecalendarDateSelected = "", onlineofflineID = "", today = (new Date()), year = (today.getFullYear()), month = (today.getMonth() + 1), day = (today.getDate()), ttodayDatew = (year + '' + ((month < 10) ? ('0' + month) : month) + '' + ((day < 10) ? ('0' + day) : day))/*yyyymmdd*/
    ;
    preventContextMenu();
        ...
        $(".signoutClick").click(function(){
                $.post(apiC,{cros:"getterCross",signlogout:0},
                    function(da){
                        ...
                        sharparp.push({
                            title: sharparp.option.title.setlogout,
                            value: "/index.php"});
                });
        });
        //
